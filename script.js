...
function startGame() {
    ...
    myGamePiece = new component(20, 20, "tomato", 350, 220);
    myGamePiece.gravity = 0.05;
    myScore = new component("30px", "Roboto", "black", 80, 40, "text");
    myGameArea.start();
...
function component(width, height, color, x, y, type) {
    ...
    this.update = function() {
        ...
        if (this.type == "text") {
            ...
            ctx.fillStyle = color;
           // ctx.arc(this.x, this.y,this.width,this.height,10,Math.PI*2);
